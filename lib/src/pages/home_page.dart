...
//---------------------------module packag--------------------------------------
import 'package:flutter_wallet_ui_challenge/src/modules/bottom_bar.dart';
//---------------------------other package--------------------------------------
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: bodyHome(context, _media),
      bottomNavigationBar: _bottombar.bottomBarInit(),
  ...
  ListView bodyHome(BuildContext context, Size _media) {
    return ListView(
